package io.codelex.secondT.exercise5;
...
public class GenericMethod {
    ...
    public static <T> Double partOf(List<T> myList, Predicate<T> myFunction) {
        double listSize = myList.size();
        return myList.stream().filter(myFunction).count() / listSize;
